   ...
   <Container class1='checkout-wrapper py-5 home-wrapper-2'>
        ...
        <div className='col-7'>
          <div className='checkout-left-data'>
            <h3 className='website-name'>Dev Zone</h3>
  ...
  <ol className="breadcrumb">
    ...
    <li className="breadcrumb-item total-price active" aria-current="page">Payment</li>
          ...
          <p className='user-details total'>
            Ali Hassan (ah4807325@gmail.com)
          </p>
        ...
        <div className='border-bottom py-4'>
          ...
          <div className='w-75 d-flex gap-10'>
            <div className='w-25 position-relative' >
              <span style={{top:"-15px", right:"-10px"}}
              className='badge bg-secondary text-white rounded-circle p-2 position-absolute'>
                1</span>
              <img className='img-fluid' src={tab}  alt="product"/>
            </div> 
            <div>
              <h5 className='total-price'>Honor T17.0.1 GB RAM 8 GB ROM 7 inch with Wi-Fi+3G tablet
              </h5>
              <p className='total-price'>s/ hgcfhgt</p>
            </div>
            </div>
          <div className='flex-grow-1'>
          ...
          <div className='w-75 d-flex gap-10'>
            ...
            <div>
              <h5 className='total-price'>Honor good speaker quality, with bluetooth connection, wirless
              </h5>
              <p className='total-price'>s/ hgcfhgt</p>
            </div>
            </div>
          <div className='flex-grow-1'>
            <h5 className='total'>$ 80.99</h5> 
            </div>
          </div>
        </div>
        <div className='border-bottom py-4'>
        ...
        <div className='d-flex justify-content-between align-items-center'>
          ...
          <p className='mb-0 total-price'>$ 219.65</p>
        </div>
        </div>
